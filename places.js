       ...
       const clickListener = function(ev) {
        ...
        if (el && el === ev.target) {
           ...
           //msg.innerText = distanceMsg;
            btn.innerText = 'Close';
            container.setAttribute('class', 'card text-white  text center bg-dark z-index-n1 position-relative mb-3');
